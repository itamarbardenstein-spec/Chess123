namespace Chess.Models
{
    static class Strings
    {
        ...
        public const string WeakPasswordErrMessage = "Password needs to be at least six characters long";
